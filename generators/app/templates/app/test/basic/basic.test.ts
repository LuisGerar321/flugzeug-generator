...
describe(`${chalk.green("> Basic")} ${chalk.magenta("app")} ${chalk.green("unit test.")}`, () => {
  ...
  describe(chalk.yellow("#validateJWT():"), () => {
  ...
  describe(chalk.yellow("#createToken():"), () => {
  ...
  describe(chalk.yellow("#getCredentials():"), () => {
    ...
    it("token should be an object token type.", async () => {
      ...
      const expectedToken: AuthCredentials = {
        token:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwic3ViIjoiYWNjZXNzIiwiYXVkIjoidXNlciIsImV4cCI6MTY1NzgxNjA3NS41NSwiaWF0IjoxNjU1MjI0MDc1LjU1LCJqdGkiOiIyODM2OTYwNy00MWNmLTQ2Y2MtOWFhYy04NWRjYzIwYmE5MTAiLCJlbWFpbCI6ImFkbWluQGV4YW1wbGUuY29tIiwicm9sZXMiOlsxXX0.arwSKCYXhBjKW7gcesh7Y05n2zwbDrMkCdtqTQL-pAo",
        expires: 1657816075.55,
        refresh_token: {
          token:
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwic3ViIjoicmVmcmVzaCIsImF1ZCI6InVzZXIiLCJleHAiOjE2NzEwMzg4NzUuNTUsImlhdCI6MTY1NTIyNDA3NS41NSwianRpIjoiYzU4Y2QyNDgtNjI5Yi00NmNmLWI5YjktZDRmOTkyOTU3OWYwIiwiZW1haWwiOiJhZG1pbkBleGFtcGxlLmNvbSIsInJvbGVzIjpbMV19.pdkHBOHJtg_TSbHATFlFJiej18mCUH12h1O3_Nu-UgE",
  ...
  describe(chalk.yellow("#createUser():"), () => {
    it("should not obtain the null credentials", async () => {
      let newUser: User;
      try {
        newUser = await onboardingService.createUser(
          "Jorge",
    ...
    it("should be user object type", async () => {
      ...
      const userCreated: Partial<User> = {
        ...
        password:
          "$2b$10$QqbA.msasnjpF4EYDLaZyeGRRjp7iWwRXGu.X0sjtpXuWDAkGHd.6",
